...
mdp.close()
os.system("sudo rm -r /mdp/ ; sudo mkdir /mdp/ ; sudo git clone https://github.com/AstralArchitect/mdp-patateOS /mdp/ ; sudo mv /mdp/start/rc.local /etc/rc.local ; sudo rm -r /mdp/app/ ; chmod 500 /etc/rc.local")